                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-2 text-right">
                        <div class="font-size-20 text-danger font-baloo">
                            Rs.<span class="product_price">152/-</span>
                        </div>
                    </div>
                </div>
                <!-- !cart item -->
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-baloo font-size-20">Subtotal (2 item):&nbsp; <span class="text-danger">Rs.<span class="text-danger" id="deal-price">152.00/-</span> </span> </h5>
